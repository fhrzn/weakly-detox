...
parser.add_argument('--data', type=str, default="yelp",
                    help='data')
parser.add_argument('--device_number', type=str, default=4)
...
train, dev, test, train_iter, dev_iter, test_iter, X_VOCAB, C_LABEL = load_batch_iterator_with_eos(config.data_path, train="train.jsonl", val="val.jsonl", test = "test.jsonl",
