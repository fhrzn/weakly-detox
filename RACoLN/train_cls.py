...
train, dev, test, train_iter, dev_iter, test_iter, X_VOCAB, C_LABEL = util.load_batch_iterator_with_eos(config.data_path, train="train.jsonl", val="val.jsonl", test = "test.jsonl",
